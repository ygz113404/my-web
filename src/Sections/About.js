...
function About() {
    return (
      ...
      <div  id="about" className="max-w-[1000px]  mx-auto grid md:grid-cols-2 gap-4   h-screen bg-white">
     <div className="m-auto p-4 leading-8">
        <h1 className=" text-2xl font-bold py-1 md:text-4xl">About Me</h1>
